...
const SliderComponent = ({ stories }) => {
  ...
  return (
    <div className="relative w-full h-full">
          ...
          <>
            <div className=" max-w-xl mx-auto">
              <SwiperSlide>
                <div
                  key={index}
                  className="flex flex-col items-center justify-center w-full p-0 shrink-0 snap-start rounded-xl"
                >
                  <img
                    className="w-full max-w-full rounded-xl imgwrapper"
                    src={data.image}
                    alt="placeholder image"
                  />

                  <div className="relative bottom-0 z-50  max-w-5xl mx-auto flex flex-col sm:flex-row gap-8 sm:gap-6 items-center justify-between w-full my-4">
                    <div className="flex flex-col gap-1 flex-1">
                      <span className="text-2xl text-[#6B7280] ">
                        <a
                          href="#"
                          className="text-2xl text-black dark:text-white font-body font-medium"
                        >
                          {data.preseed}
                        </a>
                      </span>
                      <span className="text-2xl text-[#6B7280] ">
                        <a
                          href="#"
                          className="text-2xl text-black font-body dark:text-white font-medium"
                        >
                          {data.seed}
                        </a>
                      </span>
                    ...
                    <div className="">
                      <a
                        ...
                        target="_blank"
                        className="py-4 px-6 rounded-xl text-white bg-black dark:bg-white/5 inline-flex items-center gap-2 hover:cursor-pointer"
                      >
                        Read the Story{" "}
                        <span>
      ...
      <div className="absolute -top-28 xl:-top-16  flex justify-between w-full mx-auto h-[90%]">
        <button
          ref={prevButtonRef}
          className="text-6xl prev -ml-6 lg:-ml-16  z-10"
          id="prev-button"
          onClick={() => {
        ...
        >
          <span
            aria-hidden="true"
            className="h-12 w-12 flex items-center justify-center rounded-full border-[.9] bg-white dark:bg-white/5"
          >
            <svg
              width="8"
              height="15"
              className="text-gray-300 lg:h-8 hover:text-gray-400"
              viewBox="0 0 8 15"
              fill="none"
        ...
        <button
          ref={nextButtonRef}
          className="text-6xl next -mr-6 lg:-mr-16  z-10"
          id="next-button"
          onClick={() => {
            console.log("clicked");
